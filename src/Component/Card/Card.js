...
const Card = (props) => {
    const { name, img, description, step, time } = props.exercise;
    return (
        <div className="card card-compact w-70  bg-base-100 shadow-xl relative rounded-xl pb-16">
            ...
            <button className='w-[95%] border text-white bg-green-600 font-bold 
                rounded-xl hover:text-green-600 hover:bg-white hover:border-green-600 absolute bottom-0 p-2 m-2'>Add to list</button>
